...
<section class="add_product_section1">
    <div class="container">
        ...
        <form class="row g-3 pt-2 pb-5 col-md-12 d-flex flex-row" action="" name="addCardForm" id="addCardForm" method="post">
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-12">
                            <select class="form-custom-input form-select" name="card_expiry_year" id="card_expiry_year">
            ...
            <div class="col-12 col-sm-12 col-md-8 col-lg-8 text-center my-5">
                <button type="button" class="btn bg-blue btn-hover text-white text-uppercase" id="addCardSubmitBtn">Save Card</button>
                <a href="{{@$data['prevURl']}}" class="btn bg-blue btn-hover text-white text-uppercase ms-2" id="addCardSubmitBtn">‎Cancel</a>
            </div>
        </form>
                                                    ...
                                                    if (response.success == 1) {
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed) {
                                                                ...
                                                                } else if (prevURl.indexOf("/my-cart") != -1) {
