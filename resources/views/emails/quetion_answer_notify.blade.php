	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left: 10px;">
				...
				<tr>
					<td align="center">
					<p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase;">RESPONSE RECEIVED</p>
					<p  style="font-family: Arial;font-size: 16px; color:#242424;">You have received a response from <a href="{{ $store_url }}" style="color:#306eba;">{{ $store_name }}</a></p>
					<p  style="font-family: Arial;padding-top:30px;font-size: 16px;color:#242424;">{{$answer}}</p>
					</td>
				</tr>
