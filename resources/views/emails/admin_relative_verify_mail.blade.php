                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <div class="dataDiv" style="font-family: Arial; font-size:16px; color:#242424;padding:0 60px;">
                                                            ...
                                                            Hello Admin,
                                                            <br/><br/>
                                                            {{ $first_name }} register as your relative.<br/>
                                                            Please click the below button to see details of user.
                                                            <br/>
                                                            <a href="{{url('relative' .'/'.$verify_user_token)}}" style="display: block;width: 50%; margin-top: 26px; margin-left: 114px; background: #306eba;color: #fff;text-decoration: none;   font-size: 15px;font-weight: 600; padding: 16px;  text-align: center; text-transform: capitalize;">View Details</a><br/>
                                                            <!-- <br/><br/>
                                                            Regards<br/>
                                                            {{ env('MAIL_TEAM') }}
                                                            <br/><br/> -->
