            ...
            <tr>
                <td>
                    ...
                    <table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left:20px;padding-right:20px;">
                        <tr>
                            <td align="center">
                                <p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase; ">Contact Received</p>
                                                        
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Thankyou for contacting Classroom Copy.<br>
                                Our team will be in touch as soon as possible to assist you with your query.</p>
                            </td>
                        </tr>
                        <tr>
