            ...
            <tr>
                <td>
                    ...
                    <table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left: 10px;">
                        <tr>
                            <td align="left">
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Hello,</p>
                                <p style="font-family: Arial;font-size:16px; color:#242424;">You have received a request from <b>Classroom Copy</b>. Details are :</p>
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Name : {{ $name }}</p>
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Email : {{ $email }}</p>
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Phone : {{ $phone }}</p>
                                <p style="font-family: Arial;font-size:16px; color:#242424;">Message : {{ $mail_message }}</p>                           
                            </td>
                        </tr>
                        <tr>
