			...
			<tr>
				<td>
					...
					<table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left:20px;padding-right:20px;">
						<tr>
							<td align="center">
								<p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase;">Reported Product Issues</p>
								<p style="font-family:Arial; font-size:16px; line-height:18px; color:#242424;">Thankyou for contacting us in relation to a recent concern.<br>
								Our team will be investigating this matter and will be in touch <br> as soon as possible.</p>
							</td>
						</tr>
						<tr>
