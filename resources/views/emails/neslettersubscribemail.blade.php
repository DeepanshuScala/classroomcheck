	...
	<tr>
		<td>
			...
			<table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left: 10px;">
				<tr>
					<td align="center">
						<p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase; ">Newsletter Subscription</p>
						<p style="font-family: Arial;font-size: 16px;color:#242424;">Thankyou for signing up to receive the Classroom Copy Newsletter.<br>
						You can manage your subscriptions at any time through <a href="{{url('/account-dashboard/my-profile')}}" style="color:#000;"><b>My Account Details</b></a></p>
					</td>
				</tr>
                <tr>
					<td style="padding: 12px 15px 20px;">
