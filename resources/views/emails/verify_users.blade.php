                  ...
                  <tr>
                    ...
                    <td width="697" align="left">
                      <table width="696" cellspacing="0" cellpadding="1" border="0" bgcolor="#FFFFFF">
                        <tr>
                          <td align="left">
                            <div class="dataDiv" style="font-family: Arial;font-size: 16px;color:#242424;padding:0 60px;">
                              <br>
                              Hello {{ $first_name }},
                              <br>
                              <br>
                              ...
                              <br>
                              <a href="{{url('register/user/verify', $verify_user_token)}}" style="display: block;width: 50%; margin-top: 26px; margin-left: 114px; background: #007bff;color: #fff;text-decoration: none;   font-size: 15px;font-weight: 600; padding: 16px;  text-align: center; text-transform: capitalize;">Verify Email Address</a><br>
                              <!-- <br><br>
                              Regards<br>
                              {{ env('MAIL_TEAM') }}<br><br> -->
                            </div>
                              ...
                              <tr>
                                <td align="center">
                                  <a href="{{url('/')}}" target="_blank"  style="text-decoration: none;">
                                    <img src="http://classroomcopy.com/home/public/images/logo.png" width="150" style="margin-top: 10px;">
                                  </a>
                                </td>
                              </tr>
                              ...
                              <tr>
                                <td align="center">
                                      <a href="https://www.facebook.com/ClassroomCopy" target="_blank"  style="text-decoration: none;padding-left:5px;padding-right: 5px;">
                                        <img src="http://classroomcopy.com/home/public/images/emailer-facebook.png" alt="facebook" width="24" height="24">
                                      </a>
                                      <a href="https://www.instagram.com/classroomcopy/ " target="_blank" style="text-decoration: none;padding-left:5px;padding-right: 5px;">
                                        <img src="http://classroomcopy.com/home/public/images/emailer-instagram.png" alt="facebook" width="24" height="24">
                                      </a>
                                      <a href="https://www.linkedin.com/company/classroom-copy" target="_blank" style="text-decoration: none;padding-left:5px;padding-right: 5px;">
                                        <img src="http://classroomcopy.com/home/public/images/emailer-linkedin.png" alt="facebook" width="24" height="24">
                                      </a>
                                  </td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td style="padding: 30px 15px 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                              <tr>
                                <td align="center" style="padding-top: 10px;padding-bottom: 10px;font-family: Arial;font-size: 18px;">Team Classroom Copy</td>
                              </tr>
                              <tr>
                                <td><hr></td>
                              </tr>
                              ...
                              <tr>
                                <td align="center">
                                  ...
                                  <a href="#" target="_blank" style="text-decoration: none;padding-left:5px;padding-right: 5px;">
                                    <img src="{{asset('images/emailer-twitter.png')}}" alt="facebook" width="24" height="24">
                                  </a>
                                </td>
                              </tr>
                            </table>
