    ...
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8 Content-Type: image/png">
            ...
            <style type="text/css">
				...
				p{
					font-family: Arial;font-size: 16px;color:#242424;
				}
            </style>
    </head>
    <body>
				...
				<table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left: 10px;">
					<tr>
						<td align="center">
							<?php
								if(isset($storeinbox)){
									$heading = 'Latest news from your favorite seller';
								}
								else{
									$heading = isset($sell)?'YOUR FAVOURITE SELLER IS HAVING A <span style="color:red;">SALE!</span>':'New Product From Your Favourite Seller';
								}
							?>
							<p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase; ">{!! $heading !!}</p>
							<p style="font-family: Arial;font-size: 16px;color:#242424;">{!! $data !!}</p>
						</td>
					</tr>
					<tr>
