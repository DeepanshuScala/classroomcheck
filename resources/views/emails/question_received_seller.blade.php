			...
			<tr>
				<td>
					...
					<table border="0" cellpadding="15" cellspacing="0" style="width: 100%;padding-top: 50px;padding-left: 10px;">
						...
						<tr>
							<td align="center">
							<p style="font-family: Arial;font-size: 18px;color:#306eba;text-transform: uppercase;">QUESTION RECEIVED</p>
							<p  style="font-family: Arial;font-size: 16px;color:#242424;">You have received a question from <span style="color:#306eba;">'{{$user_name}}'</span></p>
							<p  style="font-family: Arial;padding-top:30px;color:#306eba;font-size: 16px;">'{{$question}}'</p>
		                    <p  style="font-family: Arial;padding-top:30px;font-size: 16px;color:#242424;"><a href="{{url('/store-products/?tab=Communication-tab')}}" style="color: color:#242424; !important;">Respond to question</a></p>
							</td>
						</tr>
						<tr>
