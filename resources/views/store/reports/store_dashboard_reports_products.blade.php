        ...
        <div class="container">
            ...
            <div class="row row-cols-5 col-12 row-cols-sm-12 row-cols-md-3 row-cols-lg-3 row-cols-xl-5 gx-3 gx-sm-4">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-3 ">
                    <a href="{{route('storeDashboard.reports.products')}}">
                        <div class="card card-box highlight-yellow text-center h-100 py-4 ">
                            <div class="card-body das-card">
            ...
            <div class="row py-5">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <h1 class="text-uppercase">Products Report</h1>
                </div>
            </div>
            ...
            <div class="row py-5">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 sales-report-data ">
                    <h5 class="bg-blue text-uppercase text-center text-white p-3"> Product Report </h5>
                    <div class="table-responsive">
                        <table class="table sales-report-data-products" id="fixed_table">
                            <thead>
                                <tr>
                                    <th scope="col">Product Title <span class="ps-1"><a href="#"><i class='fas fa-caret-up fa-xs'></i></a><a href="#"><i class='fas fa-caret-down fa-xs '></i></a></span></th>
                                    <th scope="col">Product Posted </th>
                                    <th scope="col">Average Rating<br><span class="period">(since listing)</span> </th>
                                    <th scope="col">Single<br> License Sales <br><span class="period">(for period)</span></th>
                                    <th scope="col">Multiple<br>License Sales<br><span class="period">(for period)</span> </th>
                            ...
                            <tbody>
                                ...
                                if(count($data['sales']) > 0){
                                    ...
                                    <tr class="bg-success bg-opacity-5">
                                        <th scope="row">{{$pr['product_name']}}</th>
                                        <td>{{$pr['posted']}}</td>
                                        <td>{{round($pr['rating'],2)}}</td>
                                        <td>{{isset($pr['single_numberofsales']) ?$pr['single_numberofsales']:0;}}</td>
                                        <td>{{ isset($pr['multiple_numberofsales']) ?$pr['multiple_numberofsales']:0; }}</td>
