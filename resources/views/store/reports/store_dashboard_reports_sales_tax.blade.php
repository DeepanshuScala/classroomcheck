...
@section('content')
<!--Store Dashboard Section SALE TAX Starts Here-->
        ...
        <div class="container">
            ...
            <div class="row row-cols-5 col-12 row-cols-sm-12 row-cols-md-3 row-cols-lg-3 row-cols-xl-5 gx-3 gx-sm-4">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-3 mb-3 ">
                    <a href="{{route('storeDashboard.reports.salesTax')}}">
                        <div class="card card-box highlight-blue text-center h-100 py-4 ">
                            <div class="card-body das-card">
            ...
            <div class="row py-5">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <h1 class="text-uppercase">Sales Tax Report</h1>
                </div>
            ...
            <div class="row py-5">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 sales-report-data">
                    <h5 class="bg-blue text-uppercase text-center text-white p-3"> Sales tax Report</h5>
                        ...
                        <table class="table" id="fixed_table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Shipped to <br><span class="period">(Country)</span> </th>
                                    <th scope="col">Shipped From<br><span class="period">(Country)</span> </th>
                            ...
                            <tbody>
                                ...
                                if(count($data['sales']) > 0){
                                    ...
                                    <tr class="bg-success bg-opacity-5">
                                        ...
                                        <td>{{$pr['shipped_to']}}</td>
                                        <td>{{$pr['shipped_from']}}</td>
                                        <td>${{number_format((float)$pr['sale_amount'], 2, '.', '')}}</td>
                                        <td>${{number_format((float)$pr['sales_tax_collected'], 2, '.', '')}}</td>
                                    </tr>
                                    <?php 
                                    }
                                }
    ...
    <!--Store Dashboard Section SALE TAX Ends Here-->
@endsection
    ...
    $(function () {
        ...
        $(document).on('submit','form[name="sale_filter"]',function(e){ 
            ...
            if(orderid == '' && startdate == ''){
                Swal.fire({
                    title: 'Oops!',
                    text: "Please select a date range or enter orderid",
                    icon: 'warning',
