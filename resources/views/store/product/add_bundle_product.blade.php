        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="inner_page_title">
                    <h1>Add Bundle Product To Your Store</h1>
                </div>
            </div>
            <div class="col-md-4">
...
<section class="add_product_section">
    <div class="container">
        ...
        <form class=" g-3 pt-2 pb-5 " action="{{route('storeDashboard.addBundleProduct.post')}}" name="addProductForm" id="addProductForm" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row ">
                        <?php
                        $productslist = (new App\Http\Helper\ClassroomCopyHelper())->getProducts();
                        ?>
                        <div class="col-md-2 col-12">
                            <label for="selectStandards" class="form-label fw-bold float-start mt-0 mt-md-3">Products</label>
                        </div>
                        <div class="col-md-9 col-12 " id="productlistdiv">
                            <select class="form-select bg-light select2" multiple name="products[]" id="products" data-placeholder="Select products">
                                <option value="" disabled>Select products</option>
                                @foreach($productslist as $pl)
                                    <option value="{{$pl->id}}" {{ old('products') == $pl->id ? 'selected' : '' }} >{{$pl->product_title}}</option>
                                @endforeach
                            </select>
...
<script>
    $("form[name='addProductForm']").submit(function (event) {
        ...
        var products = addProductForm.find("#products :selected").val();
        ...
        if (products == "" || typeof products === 'undefined') {
            addProductForm.find("#products").focus().select();
            addProductForm.find("#productlistdiv").append('<span class="error text-danger error_msg">Select products</span>');
            return false;
        } 
