            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="row ">
                        ...
                        $addedproducts = json_decode($data['prodRes']->bundleproducts);
                        ?>
                        <div class="col-md-2 col-12">
                        ...
                        <div class="col-md-9 col-12 " id="productlistdiv">
                            <select class="form-select bg-light select2" multiple name="products[]" id="products" data-placeholder="Select products">
                                ...
                                @foreach($productslist as $pl)aaaaaaaa
                                    <option value="{{$pl->id}}" {{ (in_array($pl->id, $addedproducts)) ? 'selected' : '' }} >{{$pl->product_title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
