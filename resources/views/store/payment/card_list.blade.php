                ...
                foreach ($data['result'] as $row) {
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 mb-4">
                        <div class="card-payment-list">
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="{{ URL('/seller/update-card').'/'.$row['id'] }}" class="btn-hover btn btn-primary bg-blue btn-lg px-4 my-2 me-2 w-50 text-uppercase">
                                    Edit
                                </a>
                    ...
                    <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 mb-5">
                        <div class="align-items-center">
                            ...
                            <div>
                                <a href="{{ URL('/seller/update-card').'/'.$row['id'] }}" class="btn btn-warning btn-sm mt-3">
            ...
            $('.removeCard').click(function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "<?php echo URL('/seller/remove-card') ?>" + '/' + id;
                    }
                });
            });
        });
