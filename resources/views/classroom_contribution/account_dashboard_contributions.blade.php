        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="store-dashboard my-md-0 my-3">
                    <a href="{{route('account.dashboard')}}"><img src="{{asset('images/store-icon.png')}}" class="img-fluid me-1 my-1"> Account Dashboard</a>
                </div>
            </div>
        </div>                    
...
<section class="contribution-main new-contribution tete">
    <?php
