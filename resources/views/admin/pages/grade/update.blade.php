...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Update {{$pageHeading}}</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a class="text-blue" href="{{ URL('admin/dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Update {{$pageHeading}}</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-blue">
        <div class="card-header">
            <h3 class="card-title">Update {{$pageHeading}}</h3>
        ...
        <div class="card-body">
            ...
            @endif
            <form action="" method="post" name="updateResourceForm" id="updateResourceForm">
                @csrf
                <div class="form-group">
                    <label>Grade Level</label>
                    <input type="text" name="name" id="name" value="{{ (old('name') == null) ? $result->grade : old('name') }}" class="form-control" required="" placeholder="Grade Level">
                </div>
