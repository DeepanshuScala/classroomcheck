    ...
    <div class="card card-blue">
        <div class="card-header text-white">
            <h3 class="card-title w-100">{{ $pageHeading }}s
                <a href="{{ URL('admin/subject/add-sub-subject') }}" class="btn btn-warning float-right btn-sm">Add Sub Subject</a>
                <a href="{{ URL('admin/subject/add-subject') }}" class="btn btn-warning float-right btn-sm mr-2">Add Subject</a>
            </h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    foreach ($result as $key => $val) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
                                &nbsp;
                                <a href="{{ URL('admin/subject/update-subject').'/'.$val->id }}" class="btn btn-warning text-white btn-xs" title="Update Subject">
                                    <i class="fa fa-edit"></i>
                                </a>
                                &nbsp;
                                <a href="{{ URL('admin/subject/delete-subject').'/'.$val->id }}" class="btn btn-danger text-white btn-xs " title="Delete" onclick="return confirm('Are you sure you want to delete?')">
