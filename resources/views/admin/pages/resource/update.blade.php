        ...
        <div class="card-body">
            ...
            <form action="" method="post" name="updateResourceForm" id="updateResourceForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" value="{{ (old('name') == null) ? $result->name : old('name') }}" class="form-control" required="" placeholder="Resource Type">
                </div>
