document.querySelectorAll(".drop-zone__input").forEach((inputElement) => {
  ...
  function updateThumbnail(dropZoneElement, file,inputElement="") {
    ...
    if(dropZoneElement.classList.contains('store-logo')){
      inputElement.setAttribute('name','store_logo');
    }

    if(dropZoneElement.classList.contains('store-banner')){
      inputElement.setAttribute('name','store_banner');
    }
